...
export default function CostEstimator() {
  ...
  const courseData = {
    ...
    BSN: { name: "Nursing (BSN) — $3,000-5,000/yr", tuition: 2500, visa: 350 },
    BEng: { name: "Engineering - $2,000-5,000/yr", tuition: 3500, visa: 350 },
    MBA: {
      name: "Business / MBA - $2,500-7,000/yr",
      tuition: 4750,
      visa: 350,
    },
    CS: {
      name: "Computer Science - $1,500-4,000/yr",
      tuition: 2750,
      visa: 350,
    },
    ESL: {
      name: "ESL / English - $800-2,500/yr",
      tuition: 1650,
      visa: 350,
    },
  };
  ...
  const cityData = {
    ...
    quezon: { name: "Quezon City", modifier: 0.95 },
    cebu: { name: "Cebu City", modifier: 0.85 },
    davao: { name: "Davao City", modifier: 0.8 },
    baguio: { name: "Baguio City", modifier: 0.7 },
    iloilo: { name: "Iloilo City", modifier: 0.65 },
  };

  const lifestyleData = {
    budget: { name: "Budget - careful spender", cost: 4800 },
    moderate: { name: "Moderate - comfortable", cost: 7440 },
    comfortable: { name: "Comfortable - more", cost: 12000 },
  };
  ...
  return (
    <section
      id="estimator"
      className="relative bg-[#1b2e4b] text-white py-24 px-6 md:px-12 overflow-hidden border-b border-white/5"
    >
      ...
      <div className="max-w-7xl mx-auto text-center mb-16 relative z-10">
        ...
        <h2 className="font-serif text-4xl sm:text-5xl font-bold text-white mt-3 leading-tight">
          Cost of studying in the
          <br />
          Philippines
        </h2>
        <p className="text-sm sm:text-base text-gray-300 font-medium mt-4 max-w-2xl mx-auto leading-relaxed">
          Get an instant estimate of your annual costs. Choose your course,
          city, and lifestyle below.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mt-8 text-xs text-gray-400 max-w-4xl mx-auto leading-relaxed relative z-10">
          Estimates only, in USD, for general planning. Actual costs vary by
          school and circumstances — contact us for exact figures.
        </div>
      </div>
    </section>
  );
