        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[480px]">
              ...
              {/* FLOATING CONTEXTUAL BADGE A (TOP-LEFT) */}
              <div className="absolute top-10 -left-6 z-20 shadow-2xl flex items-center gap-2.5 bg-white/90 backdrop-blur-md border border-white rounded-2xl px-4 py-2.5 text-xs text-primary font-black animate-float-card-delayed">
                <span className="w-6 h-6 rounded-full bg-emerald-500/10 text-emerald-600 flex items-center justify-center text-[10px] font-black border border-emerald-500/15">✓</span>
                <span>🛂 Visa Approved</span>
              </div>

              {/* FLOATING CONTEXTUAL BADGE B (MIDDLE-RIGHT) */}
              <div className="absolute top-1/2 -right-8 z-20 shadow-2xl flex items-center gap-2.5 bg-white/90 backdrop-blur-md border border-white rounded-2xl px-4 py-2.5 text-xs text-primary font-black animate-float-card">
                <span className="text-orange-accent text-sm">✈️</span>
                <span>Flight Secured</span>
              </div>

              {/* FLOATING CONTEXTUAL BADGE C (BOTTOM-LEFT) */}
              <div className="absolute bottom-12 -left-8 z-20 shadow-2xl flex items-center gap-2.5 bg-white/90 backdrop-blur-md border border-white rounded-2xl px-4 py-2.5 text-xs text-primary font-black animate-float-card-delayed">
                <span className="text-gold-accent text-sm">🔑</span>
                <span>Settle Active</span>
              </div>
